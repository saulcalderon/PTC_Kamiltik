...
<div class="padd-15">
    ...
    <div class="nav-wrapper">
        <div class="col s12 green-text">
            <a href="bills.php" class="breadcrumb black-text">Bills</a>
            <a href="" class="breadcrumb black-text">Create Bill</a>
        </div>
    </div>
    <!-- Contenedor -->
        ...
        <div class="col s12 m3">
            <div class="card padd-15">
                <div class="row center">
                    ...
                    <h6 id="cambio" class="margin-10">Change: $</h6>
                    ...
                    <form action="" method="post">
                        <div class="input-field col s12">
                            ...
                            <label for="entregado">Delivered by customer</label>
                        </div>
                    </form>
                    <!-- Botones generales -->
                    <!-- Botón para finalizar la factura -->
                    <a href="#" class="margin-10 block waves-effect waves-light btn-large" onclick="actionBill('finalizar')" data-tooltip="Finalizar factura"><i class="material-icons left">assignment_turned_in</i>End Bill</a>
                    <!-- Botón para dejar pendiente la factura -->
                    <a href="#" class="margin-10 block waves-effect waves-light btn-large" onclick="actionBill('pendiente')" data-tooltip="Factura pendiente"><i class="material-icons left">assignment_return</i>Pending</a>
                    <!-- Botón para eliminar la factura -->
                    <a href="#" class="margin-10 block waves-effect waves-light btn-large" onclick="actionBill('eliminar')" data-tooltip="Eliminar factura"><i class="material-icons left">assignment_late</i>Delete Bill</a>
                </div>
            </div>
        </div>
