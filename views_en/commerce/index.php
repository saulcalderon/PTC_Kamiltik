    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6 l4">
                <h3 class="ftf-medium">Search Branches</h3>
                <div class="row">
                    ...
                    <form class="col s12">
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <label for="first_name" class="ftf-medium">Search by address</label>
                                <i class="material-icons prefix">search</i>
                            </div>
                        </div>
                        <h3 class="ftf-medium">Filter</h3>
                        <div class="row">
                            <div class="input-field col s12">
                                <select>
                                ...
                                <label class="ftf-medium">Department</label>
                            </div>
                            <div class="input-field col s12">
                                <select>
                                ...
                                <label class="ftf-medium">City</label>
                            </div>
                        </div>
                        <button class="btn btn-large waves-effect waves-light red" type="submit" name="action">Search branch</button>
                    </form>
                </div>
            </div>
            <!-- Mapa insertado -->
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6">
                    <h3 class="white-text ftf-medium">Our secret</h3>
                    <p class="white-text parrafo">We are committed to creating great <br> experiences with our customers, in a <br>
                        pleasant atmosphere, with the best service and quality.</p>
                </div>
                <div class="col s12 m6">
...
<section>
    <h3 class="center ftf-medium">Our projects</h3>
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="card-image">
                        ...
                        <div class="valign-wrapper fondo-negro">
                            <span class="card-title">Alliances</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="card-image">
                        ...
                        <div class="valign-wrapper fondo-negro">
                            <span class="card-title">Curiosities about coffee</span>
                        </div>
                    </div>
                </div>
            </div>
