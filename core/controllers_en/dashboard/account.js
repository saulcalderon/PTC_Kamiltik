...
function checkUsuarios() {
    $.ajax({
        ...
        .done(function (response) {
            ...
            if (current == '/PTC_Kamiltik/views_en/dashboard/register.php') {
                ...
                if (response.status) {
                    ...
                    sweetAlert(4, 'You must create a user to get started', null);
                }
            } else {
                // Si ya existe al menos un usuario registrado se pide iniciar sesión, de lo contrario se envía a crear el primero.
                if (response.status) {
                    sweetAlert(4, 'You must authenticate to enter', null); //Cambiar
                } else {
    ...
    swal({
        ...
        .then(function (value) {
            ...
            if (value) {
                ...
                sweetAlert(4, 'You can continue with the session', null);
            }
        });
}
