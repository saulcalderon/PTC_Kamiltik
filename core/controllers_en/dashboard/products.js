...
/* Selects */
const API_TIPO_PRODUCTO = '../../core/api_en/dashboard/products.php?action=readAllTipoProducto';
const API_SUCURSAL = '../../core/api_en/dashboard/products.php?action=readAllSucursal';
const API_ESTADO_PRODUCTO = '../../core/api_en/dashboard/products.php?action=readAllEstadoProducto';
const API_ESTADO_DISTRIBUCION = '../../core/api_en/dashboard/products.php?action=readAllEstadoDistribucion';
const API_PROVEEDOR = '../../core/api_en/dashboard/products.php?action=readAllProveedor';
const API_DOCUMENTO_COMPRA = '../../core/api_en/dashboard/products.php?action=readAllDocumentoCompra';
    ...
    dataset.forEach(function (row) {
        ...
        content += `
            <tr>
                ...
                <td>
                    <a href="#" onclick="openUpdateModal(${row.id_producto})" class="blue-text tooltipped" data-tooltip="Update"><i class="material-icons">mode_edit</i></a>
                    <a href="#" onclick="openDeleteDialog(${row.id_producto})" class="red-text tooltipped" data-tooltip="Delete"><i class="material-icons">delete</i></a>
                </td>
            </tr>
        `;
    });
...
function openUpdateModal(id) {
    ...
    $('#save-modal').modal('open');
    // Se asigna el título para la caja de dialogo (modal).
    $('#modal-title').text('Modify product');
