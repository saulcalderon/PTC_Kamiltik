                ...
                <div class="card">
                    <div class="card-image">
                        ...
                        <div class="valign-wrapper fondo-negro">
                            <span class="card-title center">Historia The Coffe Cup</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-image">
                        ...
                        <div class="valign-wrapper fondo-negro">
                            <span class="card-title center">Donaciones</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-image">
                        ...
                        <div class="valign-wrapper fondo-negro">
                            <span class="card-title center">Participaciones y eventos</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-image">
                        ...
                        <div class="valign-wrapper fondo-negro">
                            <span class="card-title center">Sucursales</span>
                        </div>
                    </div>
                </div>
            </div>
